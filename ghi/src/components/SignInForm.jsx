...
const SignInForm = () => {
    ...
    useEffect(() => {
        ...
        if (signinStatus.isError) {
            setErrorMessage(
                signinStatus.error?.data?.error || 'Invalid credentials'
            )
        }
    ...
    async function handleFormSubmit(e) {
        ...
        try {
            ...
            console.log('Packer signin successful:', response)
            // Navigate to marketplace - backend already validated user type
            navigate('/marketplace')
        } catch (err) {
            console.error('Packer signin error:', err)
        }
    }
    ...
    return (
        <div className="flex justify-center outline-gray-100">
            ...
            >
                ...
                <p className="px-10 pl-0 mb-7">Welcome back</p>
                ...
                <div className="flex flex-wrap">
                    <input
                        ...
                        className="appearance-none block w-full bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md py-3 px-4 mb-5 focus:outline-orange-400 focus:bg-white focus:border-gray-500"
                    />
                    <input
                        type="password"
                        name="password"
                        ...
                        className="appearance-none block w-full bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md py-3 px-4 mb-9 focus:outline-orange-400 focus:bg-white focus:border-gray-500"
                    />
                </div>
